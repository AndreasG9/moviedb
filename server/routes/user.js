...
const { get_user, add_user, update_user_details, update_watchlist, update_favorites, update_ratings, update_list, new_list, delete_list, append_list } = require("../controllers/user_controller"); 
...
user_router.post("/:username/lists/:list/edit", update_list);
user_router.post("/:username/lists/:list/append", append_list);
