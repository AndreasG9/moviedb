...
const { get_user, add_user, update_user_details, update_watchlist, update_favorites, update_ratings, update_lists, delete_list } = require("../controllers/user_controller"); 
